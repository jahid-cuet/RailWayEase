...
class UserRegistrationForm(UserCreationForm):
    ...
    class Meta:
        model = User
        fields = ['username', 'password1', 'password2', 'first_name', 'last_name', 'email', 'account_type', 'birth_date','gender', 'postal_code', 'city','country', 'street_address','nid']
...
class UserUpdateForm(forms.ModelForm):
    ...
    class Meta:
        model = User
        fields = ['first_name', 'last_name', 'email', 'birth_date', 'gender', 'account_type', 'street_address', 'city', 'postal_code', 'country']
